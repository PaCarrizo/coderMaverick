...
from .views import menu, pagblog, pagreclamos, pagrecomendaciones,post,BlogDelete,BlogEdit,RecomendacionList,RecomendacionDetalle,RecomendacionEdit,RecomendacionDelete,ReclamosDelete,ReclamosDetalle,ReclamosList,ReclamosEdit
